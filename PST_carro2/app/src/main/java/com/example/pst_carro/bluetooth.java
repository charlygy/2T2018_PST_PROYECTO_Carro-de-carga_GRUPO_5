...
public class bluetooth extends AppCompatActivity {
    ...
    private static final String TAG = "dispositivos_bt"; //<-<- PARTE A MODIFICAR >->->
    ...
    public void onResume() {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter(this, R.layout.textviewlayout);//<-<- PARTE A MODIFICAR >->->
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(bluetooth.this, control.class);//<-<- PARTE A MODIFICAR >->->
            //Intent i2 = new Intent(dispositivos_bt.this, Principal.class);
